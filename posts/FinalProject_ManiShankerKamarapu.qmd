...
Geographical factors [will not]{.underline} be statistically predict the churn-rate.
:::

::: callout-tip
## H~1A~

Geographical factors [will]{.underline} be statistically predict the churn-rate.
:::
...
10. NumOfProducts- No of products used by customer
11. HasCrCard- If the customer has a credit card or not
12. IsActiveMember- Customer account is active or not
13. Estimated Salary- Estimated salary of the customer.
14. Exited- Indicate churned or not
