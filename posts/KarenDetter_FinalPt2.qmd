...
The first model contains all of the variables as explanatory variables for the outcome variable <govtreg>.
...
This model does not seem to be an improvement on the others, as the interaction variable is not statistically significant.

The best model, then, is likely the second one tested - the alternative model. 
