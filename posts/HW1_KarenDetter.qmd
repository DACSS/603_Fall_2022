...
```
library(readxl)
LungCapData <- read_excel("posts/_data/LungCapData.xls")
```
...
The histogram suggests that the distribution is close to a normal distribution - most of the observations are close to the mean, and very few observations are close to the margins (0 and 15).
